  ...
  const getAllDownloads = () => {
    ...
    if (data.presskit?.photos) {
      data.presskit.photos.forEach((photo, i) => {
        downloads.push({ name: `Press Photo ${i + 1}`, url: photo, type: "photo" });
      });
    }
    ...
    if (data.riders?.technical?.stagePlotUrl) {
      downloads.push({ name: "Stage Plot", url: data.riders.technical.stagePlotUrl, type: "document" });
    }
    if (data.riders?.technical?.pdfUrl) {
      downloads.push({ name: "Technical Rider PDF", url: data.riders.technical.pdfUrl, type: "pdf" });
    }
    if (data.riders?.hospitality?.pdfUrl) {
      downloads.push({ name: "Hospitality Rider PDF", url: data.riders.hospitality.pdfUrl, type: "pdf" });
    }
  ...
  if (error || !data) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-black px-4 text-center">
        <h1 className="mb-4 text-2xl font-bold text-white">Professional Materials</h1>
        <p className="mb-8 text-gray-400">
          {error ? "Failed to load materials. Please try again later." : "No materials available at this time."}
        </p>
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative flex min-h-[40vh] items-center justify-center overflow-hidden bg-gradient-to-b from-gray-900 via-black to-black">
        ...
        >
          ...
          <h1 className="mb-2 text-3xl font-bold tracking-wide text-white sm:text-4xl">{bandName}</h1>
            ...
            {contact.email && (
              <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 backdrop-blur-sm">
                ...
                <button
                  ...
                  title="Copy email"
                >
                  {copied === "email" ? <Check className="h-3 w-3 text-green-400" /> : <Copy className="h-3 w-3" />}
                </button>
              </div>
            )}
            {contact.phone && (
              <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 backdrop-blur-sm">
                ...
                <button
                  ...
                  title="Copy phone"
                >
                  {copied === "phone" ? <Check className="h-3 w-3 text-green-400" /> : <Copy className="h-3 w-3" />}
                </button>
              </div>
            )}
          </div>
      ...
      <main className="mx-auto max-w-7xl px-6 py-12">
        ...
        >
          <div className="mb-8 flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white sm:text-3xl">Press Kit</h2>
          </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              {presskit.bio?.full && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6 lg:col-span-2">
                  <h3 className="mb-4 text-sm font-medium uppercase tracking-wider text-gray-400">Biography</h3>
                  <p className="whitespace-pre-wrap text-lg leading-relaxed text-gray-300">{presskit.bio.full}</p>
                </div>
              )}
              ...
              {presskit.photos?.length > 0 && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6 lg:col-span-2">
                  <h3 className="mb-4 text-sm font-medium uppercase tracking-wider text-gray-400">Press Photos</h3>
              ...
              {presskit.logos?.length > 0 && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <h3 className="mb-4 text-sm font-medium uppercase tracking-wider text-gray-400">Logos</h3>
              ...
              {presskit.videos?.length > 0 && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <h3 className="mb-4 text-sm font-medium uppercase tracking-wider text-gray-400">Videos</h3>
                  <div className="flex flex-wrap gap-3">
              ...
              {/* Social Stats */}
              {presskit.socialStats && Object.keys(presskit.socialStats).length > 0 && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6 lg:col-span-2">
                  <h3 className="mb-4 text-sm font-medium uppercase tracking-wider text-gray-400">Social Media</h3>
                  <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
                    {Object.entries(presskit.socialStats).map(([platform, value]) => (
                      <div key={platform} className="rounded-lg border border-white/10 bg-white/5 p-4 text-center">
                        <p className="text-2xl font-bold text-white">{value}</p>
                        <p className="text-sm capitalize text-gray-400">{platform}</p>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        >
          <div className="mb-8 flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white sm:text-3xl">Technical Rider</h2>
          </div>
          ...
          {riders?.technical ? (
            <div className="grid gap-6 lg:grid-cols-2">
              {riders.technical.summary && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6 lg:col-span-2">
                  <h3 className="mb-3 text-sm font-medium uppercase tracking-wider text-gray-400">Overview</h3>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.technical.summary}</p>
                </div>
              )}
              ...
              {riders.technical.sound?.requirements && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-medium uppercase tracking-wider text-gray-400">Sound</h3>
                  </div>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.technical.sound.requirements}</p>
                </div>
              )}
              ...
              {riders.technical.lighting && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-medium uppercase tracking-wider text-gray-400">Lighting</h3>
                  </div>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.technical.lighting}</p>
                </div>
              )}

              {riders.technical.stage && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <h3 className="mb-3 text-sm font-medium uppercase tracking-wider text-gray-400">Stage Requirements</h3>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.technical.stage}</p>
                </div>
              )}

              {riders.technical.backline && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <h3 className="mb-3 text-sm font-medium uppercase tracking-wider text-gray-400">Backline</h3>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.technical.backline}</p>
                </div>
              )}

              {riders.technical.stagePlotUrl && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6 lg:col-span-2">
                  <h3 className="mb-4 text-sm font-medium uppercase tracking-wider text-gray-400">Stage Plot</h3>
                  <a
                  ...
                  >
                    <Image src={riders.technical.stagePlotUrl} alt="Stage plot" fill className="object-contain" />
                  </a>
                </div>
              )}
        ...
        >
          <div className="mb-8 flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white sm:text-3xl">Hospitality Rider</h2>
          </div>
          ...
          {riders?.hospitality ? (
            <div className="grid gap-6 md:grid-cols-2">
              {riders.hospitality.summary && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6 md:col-span-2">
                  <h3 className="mb-3 text-sm font-medium uppercase tracking-wider text-gray-400">Overview</h3>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.hospitality.summary}</p>
                </div>
              )}
              ...
              {riders.hospitality.dressing && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-medium uppercase tracking-wider text-gray-400">Dressing Room</h3>
                  </div>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.hospitality.dressing}</p>
                </div>
              )}
              ...
              {riders.hospitality.catering && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-medium uppercase tracking-wider text-gray-400">Catering</h3>
                  </div>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.hospitality.catering}</p>
                </div>
              )}

              {riders.hospitality.accommodation && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <h3 className="mb-3 text-sm font-medium uppercase tracking-wider text-gray-400">Accommodation</h3>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.hospitality.accommodation}</p>
                </div>
              )}
              ...
              {riders.hospitality.parking && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-medium uppercase tracking-wider text-gray-400">Parking</h3>
                  </div>
                  <p className="whitespace-pre-wrap text-gray-300">{riders.hospitality.parking}</p>
                </div>
              )}
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-8 text-center">
              <p className="text-gray-400">No hospitality rider available yet.</p>
            </div>
          )}
        </motion.section>
        ...
        >
          <div className="mb-8 flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white sm:text-3xl">Download Center</h2>
          </div>

          {downloads.length > 0 ? (
            <div className="rounded-xl border border-white/10 bg-white/5 p-6">
              <p className="mb-6 text-gray-400">All available materials for download:</p>
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {downloads.map((download, i) => (
                  ...
                  >
                    ...
                    {download.type === "logo" && <FileText className="h-5 w-5 text-blue-400" />}
                    {download.type === "document" && <FileText className="h-5 w-5 text-green-400" />}
                    {download.type === "pdf" && <FileText className="h-5 w-5 text-red-400" />}
        ...
        <footer className="mt-16 border-t border-white/10 pt-8 text-center text-sm text-gray-500">
          <p>
            ...
            {contact.email && (
              <a href={`mailto:${contact.email}`} className="text-amber-400 hover:text-amber-300">
                {contact.email}
              </a>
            )}
          </p>
      ...
      <AnimatePresence>
        {lightboxImage && presskit?.photos && (
          ...
          >
            ...
            >
              <Image src={lightboxImage} alt="Press photo" fill className="object-contain" />
            </motion.div>
